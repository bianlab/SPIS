...
from net.PositionalEncoding003_1k3c import *
...
class LSSPI_one(nn.Module):
    def __init__(self, picSize, patchSize,
        ...
        self.Rerrange_0 = nn.Conv2d(32, 96, kernel_size=1, stride=1)
        ...
        #self.Rerrange_0 = nn.Conv2d(56, 256, kernel_size=1, stride=1)
